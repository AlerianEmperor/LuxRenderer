...
public:
	...
	float pdf(const vec3& direction_in, const vec3& direction_out, const vec3& n, vec3& original_n) const
	{
		...
		if (cos_i <= 1e-6f || cos_o <= 1e-6f)//<=0.0f
			return 1.0f;
...
class Rough_Plastic_Extended : public BSDF_Sampling
{
public:
	float ior = 1.7f;
	float thickness = 1.0f;
	...
	Rough_Plastic_Extended() 
	{
		Prepare_For_Render(); 
		sub_material = new Rough_Glass_Fresnel(ior, roughness);
	}
	Rough_Plastic_Extended(float ior_, float roughness_, float thickness_) : ior(ior_), roughness(roughness_), thickness(thickness_)
	{
		Prepare_For_Render(); 
		sub_material = new Rough_Glass_Fresnel(ior, roughness);
	}
	Rough_Plastic_Extended(Microfacet_Distribution dist_, float ior_, float roughness_, float thickness_) : dist(dist_), ior(ior_), roughness(roughness_), thickness(thickness_)
	{
		Prepare_For_Render(); 
...
class Rough_Conductor_Extended : public BSDF_Sampling
{
public:
	float roughness;
	ComplexIor ior;
	...
	Rough_Conductor_Extended() {}
	Rough_Conductor_Extended(float roughness_, ComplexIor ior_) : roughness(roughness_), ior(ior_) {}
	Rough_Conductor_Extended(Microfacet_Distribution dist_, float roughness_, ComplexIor ior_) : dist(dist_), roughness(roughness_), ior(ior_) {}
...
class Rough_Conductor_Extended_Fix_Black_Speckled : public BSDF_Sampling
{
public:
	float roughness;
	ComplexIor ior;
	...
	Rough_Conductor_Extended_Fix_Black_Speckled() {}
	Rough_Conductor_Extended_Fix_Black_Speckled(float roughness_, ComplexIor ior_) : roughness(roughness_), ior(ior_) {}
	Rough_Conductor_Extended_Fix_Black_Speckled(Microfacet_Distribution dist_, float roughness_, ComplexIor ior_) : dist(dist_), roughness(roughness_), ior(ior_) {}
...
class Rough_Conductor_Extended_Roughness_Mapping : public BSDF_Sampling
{
public:
	//float roughness;
	ComplexIor ior;
	...
	Rough_Conductor_Extended_Roughness_Mapping() {}
	Rough_Conductor_Extended_Roughness_Mapping(ComplexIor ior_) : ior(ior_) {}
	Rough_Conductor_Extended_Roughness_Mapping(Microfacet_Distribution dist_, ComplexIor ior_) : dist(dist_), ior(ior_) {}
...
class Rough_Conductor_Extended_Absolute : public BSDF_Sampling
{
public:
	float roughness;
	ComplexIor ior;
	...
	Rough_Conductor_Extended_Absolute() {}
	Rough_Conductor_Extended_Absolute(float roughness_, ComplexIor ior_) : roughness(roughness_), ior(ior_) {}
	Rough_Conductor_Extended_Absolute(Microfacet_Distribution dist_, float roughness_, ComplexIor ior_) : dist(dist_), roughness(roughness_), ior(ior_) {}
